...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./Vista/style/StyleBitacora.css">
  </head>
  <body style="background-image: url(./Vista/img/fondo.png);">
                    ...
                    <div class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
                        <div class="table-responsive">
                            <table class="table" id="Table">
                                <thead>
                                    <tr>
                                      <th colspan="2" style="text-align: center; justify-content: center;">Registro de Acciones</th>
                                    </tr>
                                    <tr>
                                      <th scope="col" style="text-align: center; justify-content: center;">Acción</th>
                                      <th scope="col" style="text-align: center; justify-content: center;">Fecha</th>
                                    </tr>
                                </thead>
                                <tbody>    <!-- AQUI VA EL PHP INCRUSTADOOOOOOOO -->
                                    <?php
                                    if($todasBitacoras!=null)
                                    {
                                        foreach ($todasBitacoras as $b)
                                        {
                                    ?>
                                        <tr>
                                            <td><?php echo $b->getDetalle()?></td>
    ...
    <script src="./Vista/js/functionBitacora.js"></script>
</body>
</html>
